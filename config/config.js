...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\CannabisCoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/CannabisCoin/';
  if (isLinux) dataDir = process.env.HOME + '/.CannabisCoin/';
}
